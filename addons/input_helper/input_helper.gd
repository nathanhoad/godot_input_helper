...
func rumble_small(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0.4, 0, 0.1)


func rumble_medium(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0, 0.7, 0.1)


func rumble_large(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0, 1, 0.1)


func start_rumble_small(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0.4, 0, 0)


func start_rumble_medium(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0, 0.7, 0)


func start_rumble_large(_device: int = 0) -> void:
	Input.start_joy_vibration(_device, 0, 1, 0)


func stop_rumble(_device: int = 0) -> void:
